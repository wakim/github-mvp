...
class DisableAnimationsRule(): TestRule {
    ...
    private fun setAnimationScaleFactors(scaleFactor: Float) {
        try {
            ...
            Arrays.fill(mGetAnimationScalesMethod!!.invoke(mWindowManagerObject) as FloatArray, scaleFactor)
            mSetAnimationScalesMethod!!.invoke(mWindowManagerObject, mGetAnimationScalesMethod!!.invoke(mWindowManagerObject))
